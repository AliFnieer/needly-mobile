...
src/services/
    → API, storage, WebSocket, analytics and infrastructure
...
git clone https://github.com/YOUR_USERNAME/needly-mobile.git
...
https://github.com/YOUR_USERNAME/needly-backend
